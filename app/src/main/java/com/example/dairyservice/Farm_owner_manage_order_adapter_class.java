...
public class Farm_owner_manage_order_adapter_class extends FirebaseRecyclerAdapter<Farm_manage_orders, Farm_owner_manage_order_adapter_class.Farm_view_holder> {
    ...
    public Farm_owner_manage_order_adapter_class(@NonNull FirebaseRecyclerOptions<Farm_manage_orders> options, String farm_owner_email, Context applicationContext) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull Farm_view_holder holder, int position, @NonNull final Farm_manage_orders model) {

        if(model.getDelivery().equals("Offline")){
            token.add(new Token(model.getToken_number(),model.getCustomer(),model.getTotal_Price()));
        }
    ...
    public Farm_view_holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.farm_manage_orders, parent, false);

            return new Farm_owner_manage_order_adapter_class.Farm_view_holder(view);
    ...
    class Farm_view_holder extends RecyclerView.ViewHolder {
        TextView customer_email,animal,amount,total_price,delivery;
